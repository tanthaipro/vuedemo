...
<template>
    <vx-card title="Basic Grids" code-toggler>
        ...
        <div class="mt-5">
            <!-- Full width column -->
            <div class="flex mb-4">
                <div class="w-10 bg-red  h-12 flex"><span class="sm:flex hidden m-auto">w-full</span></div>
            </div>
            <div class="flex mb-4">
                <div class="w-full bg-red  h-12 flex"><span class="sm:flex hidden m-auto">w-full</span></div>
            </div>
